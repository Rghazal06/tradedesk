        ...
        html: `
          <div style="font-family: -apple-system, sans-serif; max-width: 560px; margin: 0 auto; padding: 32px;">
            ...
            <div style="background: #fef2f2; border: 1px solid #fecaca; border-radius: 12px; padding: 20px; margin: 20px 0;">
              ...
              <p style="color: #6b7280; font-size: 13px; margin: 8px 0 0;">Due: ${new Date(entry.due_date).toLocaleDateString('en-CA')}</p>
            </div>
            <p style="color: #6b7280; font-size: 13px;">Log in to TradeDesk to mark this as paid once filed.</p>
          </div>
        `,
      });
      sent++;
